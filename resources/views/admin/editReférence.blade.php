                    ...
                    <div class="card-body">
                        @if (Session::has('message'))
                               ...
                               {{ $message }}
                                ...
                                @endif
                        <form class="form-horizontal" method="POST" action="/editrefer/{{$structure[0]->id}}">
                            @csrf
                                                 
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3">Type de Référence:</label>
                                <div class="col-md-4 col-sm-3">
                                    <select class="form-control" required name="typereference" value="{{$structure[0]->idtype}}" id="typereference">
                                ...
                                <div class="col-md-4 col-sm-3">
                                    <select class="form-control" required value="{{$structure[0]->idname}}" name="name" id="name">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-3">
                                    <input type="text" class="form-control" value="{{$structure[0]->valeurajout}}" required name="valeur" placeholder="reférenc....">
                                </div>
                            </div>
