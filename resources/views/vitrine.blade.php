				...
				<div class="container-fluid">         
					...
					<div class="navbar-header">
						<a class="navbar-brand" href="index.html">
							<img src="{{ asset('assetsuser/img/logo-white.png') }}" class="logo logo-display" alt="">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-header">
							<h4 class="modal-title" id="modalLabel2">Se Connecter</h4>
						...
						<div class="modal-body">
							...
							<div class="wel-back">
								<h2>Bienvenue <span class="theme-cl">Retour!</span></h2>
							</div>
							...
							<form>
								...
								<div class="center">
									<button type="submit" id="login-btn" class="btn btn-midium theme-btn btn-radius width-200"> Connexion </button>
								</div>
			...
			<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-header">
							<h4 class="modal-title" id="modalLabel3">Crée un compte</h4>
							<button type="button" class="m-close" data-dismiss="modal" aria-label="Close">
								<i class="ti-close"></i>
							</button>
						</div>
						...
						<div class="modal-body">
							...
							<div class="wel-back">
								<h2>Hi Mate! <span class="theme-cl">CONNEXION</span></h2>
							</div>
							...
							<form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
									...
									<input type="text" name="organization" class="form-control" placeholder="socièté">
								</div>
							...
							<div class="center mrg-top-5">
								<div class="bottom-login text-center">AVEZ VOUS UN COMPTE ?</div>
								<a href="{{ route('register') }}" class="theme-cl" data-toggle="modal" data-dismiss="modal" data-target="#signin">CONNEXION</a>
							</div>
