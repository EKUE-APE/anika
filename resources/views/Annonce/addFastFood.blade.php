                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-3">
                                    <select class="selectpicker form-control col-md-12 col-sm-3" required id="type_produit_fast" name="type_produit_fast[]" multiple aria-label="Default select example" data-live-search="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-9">
                                    <select class="selectpicker form-control col-md-12 col-sm-3" required id="type_equipement" name="type_equipement[]" multiple aria-label="Default select example" data-live-search="true">
                                        <optgroup label="Choisir Le Service">
                                            @foreach($comodites as $pa)
                                            <option value="{{$pa->id}}">{{$pa->valeurajout}}</option>
                                            @endforeach 
