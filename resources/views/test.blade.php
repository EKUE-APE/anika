...
<body class="landing-page">   
            ...
            <div class="container">
                <div class="branding">
                    <h1 class="logo" style="text-align:center;">
                       <center> <img src="assetss/images/logo.png" class="img-responsive" alt="" /></center>
                    </h1>
                </div><!--//branding-->
                <div class="tagline">
    ...
    <!-- Main Javascript -->          
    <script type="text/javascript" src="assetss/plugins/jquery-1.12.3.min.js"></script>
    <script type="text/javascript" src="assetss/plugins/bootstrap/js/bootstrap.min.js"></script>                                                                     
    <script type="text/javascript" src="assetss/plugins/jquery-match-height/jquery.matchHeight-min.js"></script>
    <script type="text/javascript" src="assetss/js/main.js"></script>
